...
const Landpage3 = () =>{
    return(
        ...
        <section style={pallet3}>
            ...
            <section className="align-middle py-5" style={fontpallet1}>
                    ...
                    <section className="d-flex justify-content-center py-2">
                        <Button style={pallet4} className="p-2"><NavLink className="nav-link" to={ARTICLE}><h3 className="p-2">Telusuri</h3></NavLink></Button>
                    </section>
                </section>
